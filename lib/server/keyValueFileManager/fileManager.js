...
/*
     ...
     * there is a problem with the regex if the first line in the file is commented out
*/
var fileMgr =  {},
 ...
 * @param cb
 */
fileMgr.removeKey = function (file, key, cb) {
    fileMgr.renameKey(file, '#' + key, key, function (key1, key2) {
       if (key == false) {
           cb(false);
       } else {
           cb(key2);
