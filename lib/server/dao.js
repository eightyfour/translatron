    ...
    return {
        ...
        renameCategory: function(projectId, oldName, newName, cb) {
            this.loadProject(projectId, (projectObj) => {
                if (projectObj.keys) {
                        ...
                        Object.keys(projectObj.keys[lang]).forEach((key) => {
                            ...
                            if (oldCategoryName === oldName) {
                                if (projectObj.keyDescriptions.hasOwnProperty(key)) {
                                    projectObj.keyDescriptions[newKeyName] = projectObj.keyDescriptions[key];
                    ...
                    if (projectObj.keyDescriptions.hasOwnProperty(oldName)) {
                        projectObj.keyDescriptions[newName] = projectObj.keyDescriptions[oldName];
                        delete projectObj.keyDescriptions[oldName];
                    }
        ...
        cloneKey: function(projectId, keyAndValue, cb) {
            this.loadProject(projectId, (projectData) => {
                ...
                // Clone key description as well
                if (projectData.keyDescriptions[oldKey]) {
                    projectData.keyDescriptions[newKey] = projectData.keyDescriptions[oldKey];
