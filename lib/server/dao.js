...
var dao = function(storageDirectory, uploadDirectory) {
    ...
    return {
        ...
        loadProject: function(projectId, cb) {
            // TODO continue load from projechandler
        ...
        deleteProject: function(parentDirectory, projectName, cb) {
            ...
            var pathToFile = storageDirectory + parentDirectory + projectName + '.json';
        ...
        deleteFolder: function(parentDirectory, dirName, cb) {
            ...
            var folderPath = storageDirectory + parentDirectory + dirName;
