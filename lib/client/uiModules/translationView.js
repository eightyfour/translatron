                    ...
                    init : function (elem) {
                        ...
                        node.addEventListener('click', function () {
                            ...
                            if (validateNewKey(categoryKey) && validateNewKey(key)) {
                                ...
                                con.sendResource(newKey, 'en', '', function () {
                                    brain.projectInputCategory.node.value = '';
                                    brain.projectInputKey.node.value = '';
                                    // TODO replace with classes
                                    brain.projectInputCategory.node.style.backgroundColor = '#ffffff';
                                    brain.projectInputKey.node.style.backgroundColor = '#ffffff';
                                });
                            } else {
                                // TODO replace with classes
            ...
            printBundleTemplate : function (bundles, actualLanguage, availableProjectLanguages) {
                var keyObj,
                    ...
                    getAddNewKeyInputNode = function (category) {
                        ...
                        button.className = 'button addKeyButton octicon octicon-plus';
