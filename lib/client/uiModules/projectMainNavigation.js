...
var projectMainNavigation = (function () {
    ...
    function createFlag(lang) {
        return window.domOpts.createElement('span', null, 'flag-icon flag-icon-' + flagMap[lang]);
    }

    function setLocale(locales, node, domValue) {
        var ul = window.domOpts.createElement('ul', 'navigationMenu'), li, from, to, a, progressNode;
