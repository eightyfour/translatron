...
//                        editor.setReadOnly(true);
                    ...
                    createSaveButton = function () {
                        var button = window.domOpts.createElement('button', null, 'saveButton button');
                        button.innerText = "save";
                        button.addEventListener('click', function () {
                            console.log('SAVE CODE ON SERVER!');
                            onFileSaveQueue.forEach(function (fc) {
                                fc(editor.getValue(), obj);
                            });
                        });
                        return button;
                    };
     ...
     *  fileType,
     *  name
     *  TODO move the serverListener to the controller
     */
    ...
    return {
        ...
        onFileSaved : function (fc) {
            onFileSaveQueue.push(fc);
        }
    };
}());
