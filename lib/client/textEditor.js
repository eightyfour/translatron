...
(function () {
    ...
    var textEditor = (function () {
        ...
        function callChangeMap(id, value, fc) {
            if (onChangeMap[id]) {
                return onChangeMap[id](value, fc);
            }
            return true;
        }
        ...
        function editWithTextarea(node, id) {
            ...
            button.addEventListener('click', function () {
                var val = area.value,
                    ret = callChangeMap(id, val, function (success) {
                        if (success) {
        ...
        return {
             ...
             */
            onChange : function (id, fc) {
                if (!onChangeMap.hasOwnProperty(id)) {
                    onChangeMap[id] = fc;
                } else {
                    console.error('textEditor:onChange has already a listener for id "' + id + '" and only one is allowed!');
                }
            },
            /**
             *
