...
canny.add('projectOverview',        require('./uiModules/projectOverview'));
...
trade.addController(require('./controller/projectOverviewController'));
...
trade.ready(function () {
    ...
    trade.receivedProjectsAndDirectories(prj.path, function (obj) {
        console.log('receivedProjectsAndDirectories:', obj);
    });
