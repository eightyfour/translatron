        ...
        Object.keys(projectData.keys).forEach(function (lang) {
            if (Object.keys(projectData.keys[lang]).length > 0 && availableLanguages.indexOf(lang) !== -1) {
                ...
                if (keyValueCounter.projectMap[projectData.project].langMap[lang]) {
                    console.log('projectMainNavigationController:getMessageBundle ', keyValueCounter.projectMap[projectData.project].langMap[lang]);
                    console.log('projectMainNavigationController:getMessageBundle maxKeys are', Object.keys(keyValueCounter.projectMap[projectData.project].keyMap).length);
                    ...
                    console.log('projectMainNavigationController:getMessageBundle get language without any keys for locale:', lang);
                }
            }
        });
    },
