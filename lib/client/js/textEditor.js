...
(function () {
    ...
    var textEditor = (function () {
        ...
        function editWithTextarea(node, buttonWrap, id) {
            var open = false,
            ...
            function edit() {
                var jsTextN = node.querySelector('.js-text');
                open = true;
                originText = jsTextN.childNodes[0];
                if (!originText) {
                    originText = document.createTextNode('');
                    jsTextN.appendChild(originText);
                }
...
//                }
        ...
        return {
            ...
            add : function (node, id) {
                ...
                editIconButton.addEventListener('click', editWithTextarea(node, buttonWrap, id));
