...
var util = require('../util/url'),
    ...
    highlightTopMostKey = (function() {
        ...
        return function() {
            ...
            currentMainViewCategoryNode = document.body.querySelector('#' + firstOpenCategory.attributes.data.nodeValue.replace('anchor_', ''));
            ...
            if (mainViewTopMostKeyNode) {
                highlightedItem = rootNode.querySelector('[data=anchor_' + mainViewTopMostKeyNode.id + ']');
                if (highlightedItem) {
