var uiEvents = require('../uiEventManager.js'),
...
var projectOverview = (function() {
    ...
    function onProjectClicked(projectName) {
        console.log('User clicked at project ' + projectName);
        // TODO do not use project/directory name but the id (i.e. the path)
        // TODO for this, we have to change the server api, as of now it only fetches names
        uiEvents.callUievent('projectSelected', projectName);
    }

    function onDirectoryClicked(directoryName) {
        console.log('User clicked at directory' + directoryName);
    }
