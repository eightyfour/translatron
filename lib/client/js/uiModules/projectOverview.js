var projectOverview = (function() {
    ...
    var componentRootNode,
        ...
        onDeleteProjectsPressed = function() { console.warn('projectOverview.onDeleteProjectsPressed not set')};
    ...
    return {
        ...
        ready: function() {
            ...
            var deleteProjectsButtonNode = componentRootNode.querySelector('.js-deleteProjectsButton');
            if (!deleteProjectsButtonNode) {
                console.error('No child node with class "createFolderButton found inside "projectOverviewContainer"');
            } else {
                deleteProjectsButtonNode.addEventListener('click', function(event) {
                    onDeleteProjectsPressed();
                });
            }
        ...
        onDeleteProjectsPressed : function(func) {
            onDeleteProjectsPressed = func;
        },
