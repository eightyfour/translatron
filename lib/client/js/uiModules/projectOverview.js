var projectOverview = (function() {
    ...
    var componentRootNode,
        ...
        onToggleEditMode = function() { console.warn('projectOverview.onDeleteProjectsPressed not set')};
    ...
    return {
        ...
        ready: function() {
            ...
            var deleteProjectsToggleButtonNode = componentRootNode.querySelector('.js-deleteProjectsButton');
            if (!deleteProjectsToggleButtonNode) {
                console.error('No child node with class "createFolderButton found inside "projectOverviewContainer"');
            } else {
                deleteProjectsToggleButtonNode.addEventListener('click', function(event) {
                    if (onToggleEditMode) {
                        onToggleEditMode();
                    }
                });
        ...
        onToggleEditMode : function(func) {
