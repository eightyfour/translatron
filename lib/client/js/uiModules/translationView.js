...
var translationView = (function () {
    ...
    // QUESTION: are these real queues?
         ...
         */
        onSaveKey = function () {console.log('translationView:onSaveKey not implemented');},
        onCreateKey = function () {console.log('translationView:onCreateKey not implemented')},
        onCloneKey = function () {console.log('translationView:onCloneKey not implemented')},
