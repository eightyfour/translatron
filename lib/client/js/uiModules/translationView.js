                ...
                var keyObj,
                    ...
                    prepareCategoryNode = function (node, keyObj) {
                        ...
                        if (!categoryNode) {
                            ...
                            var categoryNodeId = categoryName ? categoryName + conf.projectPrefix : conf.projectPrefix;
                            categoryNode.setAttribute('id', categoryNodeId);
                            if (categoryName) {
                                categoryNode.querySelector('a').href = '#' + categoryNodeId;
                                categoryNode.querySelector('h2').innerText = categoryName;
