...
function getCharacterCount(value) {
    ...
    return [...value].filter((char) => /[a-zA-z]/.test(char)).length
}
        ...
        fc = {
            ...
            addLanguageField: function(node, key, value, lang, wordCount) {
                ...
                if (!textNode) {
                    ...
                    textNode.addEventListener('keyup', function () {
                        ...
                        wordCountNode.innerHTML = getWordCountText(wordCount)
                    })
            ...
            addRowWithLanguages: function(node, data, actualLanguage, allProjectLanguages) {
                ...
                allProjectLanguages.forEach(function(lang) {
                    fc.addLanguageField(row.querySelector('.translationContainer'),
                        ...
                        lang,
                        actualLanguage === lang ? data.words : 0);
                });
            },
            addLanguage: function(keys, lang) {
                ...
                categories.forEach(function(category) {
                    // TODO if category is a number the selector fails because a id can't start with number
