...
var trade = (function () {
    ...
    return {
         ...
         *
         * @param projectName
         * @param currentDir the directory in which the new project will be created
         */
        createNewProject : function (projectName, currentDir) {
            server.createNewProject(connectionId, currentDir, projectName, {}, function() {
                var args = [].slice.call(arguments);
                callController('onNewProjectCreated', args);
            })
        },
        createNewDirectory : function(directoryName, currentDirectory) {
            server.createNewDirectory(connectionId, directoryName, currentDirectory, function() {
                var args = [].slice.call(arguments);
