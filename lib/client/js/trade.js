...
var trade = (function () {
    ...
    return {
         ...
         * @param bundle project and language
         * @param data key-value
         * @param cb
         *
         * TODO must use projectID
         */
        sendResource : function (bundle, data, cb) {
            // QUESTION: what are these arguments? where are they defined?
            var args = [].slice.call(arguments);
        ...
        saveKey : function (projectId, language, keyAndValue, cb) {
            server.sendResource(
                ...
                {
                    projectId : projectId,
                    // TODO make this consistent: either "locale" or "language"
                    locale : language
                },
                keyAndValue,
                function(key, value) {
