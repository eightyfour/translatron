...
var client = function (dirName) {
    ...
    return {
        ...
        // was use for the source popup - replace by fileeditor
//        getMessageBundleSource : function (bundle,callback) {
//            fileMgr.getFileSource(dirName+'/static/'+bundle+'.properties',function(obj){
//
//                callback(obj);
//
//            });
//        },
//        setMessageBundleSource : function (bundle, data, callback) {
//            fileMgr.setFileSource(dirName+'/static/'+ bundle +'.properties', data, callback);
//            // TODO trigger refresh for all clients
//        },
